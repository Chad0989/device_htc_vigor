...
libmm-vdec-inc          += device/htc/vigor//media/mm-core/inc
#libmm-vdec-inc          += bionic/libc/kernel/common/linux
#DRM include - Interface which loads the DRM library
libmm-vdec-inc	        += $(OMX_VIDEO_PATH)/DivxDrmDecrypt/inc
libmm-vdec-inc          += device/htc/vigor/display-legacy/libgralloc
libmm-vdec-inc          += device/htc/vigor/display-legacy/libgenlock
...
mm-vdec-test-inc    := device/htc/vigor/media/mm-core/inc
...
mm-vdec-drv-test-inc    := device/htc/vigor/media/mm-core/inc
